...
setup(
  name = 'Qaver',         # How you named your package folder (MyLib)
  packages = ['Qaver'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/DevBash1/Qaver/archive/refs/tags/v_01.tar.gz',    # I explain this later on
